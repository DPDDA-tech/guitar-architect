...
export const THEME_REGISTRY: ThemeCollectionItem[] = [
  item('institutional-blue', 'Institutional Blue', 'tier0', '/Hero Guitar.webp', 'guitar6', 'common', 'Official Guitar Architect institutional identity.', undefined, 'rgba(37,99,235,0.45)', true),
