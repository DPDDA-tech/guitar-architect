...
const InstructorProfilePage: React.FC<InstructorProfilePageProps> = ({ instructorId }) => {
  ...
  if (isCEO) {
    t.personalityTitle = lang === 'pt' ? 'Personalidade, liderança e comunicação' : 'Personality, leadership and communication';
    t.noticeTitle = lang === 'pt' ? 'Liderança institucional' : 'Institutional leadership';
    t.noticeBody = lang === 'pt'
      ? 'Diana representa o Guitar Architect e comunica a visão, os valores, as novidades e a evolução do ecossistema.'
      : 'Diana represents Guitar Architect and communicates the vision, values, updates and evolution of the ecosystem.';
  }
