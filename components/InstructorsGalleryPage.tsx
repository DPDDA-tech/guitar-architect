...
const InstructorsGalleryPage: React.FC = () => {
  ...
  const t = lang === 'pt'
    ? {
        ...
        title: 'Arquitetos Musicais Virtuais',
        subtitle: 'Conheça os personagens que vão orientar sua jornada no Guitar Architect. Cada arquiteto musical representa uma forma de aprender, praticar e entender música.',
        noticeTitle: 'Galeria em construção',
        noticeBody: 'Os perfis já estão disponíveis. Em breve, os Arquitetos Musicais Virtuais serão conectados a trilhas, dicas, desafios, recomendações personalizadas e desbloqueios progressivos.',
        fictionalNotice: 'Os Arquitetos Musicais Virtuais são personagens fictícios criados para fins educacionais e de identidade visual do Guitar Architect. Suas imagens foram geradas por inteligência artificial, e seus nomes, perfis e características são fictícios. Qualquer semelhança com pessoas reais, vivas ou falecidas, é mera coincidência.',
        filterLabel: 'Filtrar por categoria',
      }
    : {
        back: '← Back to App',
        eyebrow: 'Guitar Architect',
        title: 'Virtual Music Architects',
        subtitle: 'Meet the characters who will guide your journey in Guitar Architect. Each music architect represents a way of learning, practicing and understanding music.',
        noticeTitle: 'Gallery in progress',
        noticeBody: 'Profiles are already available. Soon, the Virtual Music Architects will be connected to tracks, tips, challenges, personalized recommendations and progressive unlocks.',
        fictionalNotice: 'The Virtual Music Architects are fictional characters created for educational and visual identity purposes within Guitar Architect. Their images were generated by artificial intelligence, and their names, profiles, and characteristics are fictional. Any resemblance to real persons, living or deceased, is purely coincidental.',
