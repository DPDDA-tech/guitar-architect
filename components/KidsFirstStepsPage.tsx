...
const KidsFirstStepsPage: React.FC = () => {
  ...
  const renderInstrument = () => {
    ...
    switch (selectedModel) {
      case 'classicS':
        return (
          <svg viewBox="0 0 920 320" className="w-full h-auto max-w-[780px]" role="img" aria-label="Classic S colorivel">
      ...
      case 'singleCut':
        return (
          <svg viewBox="0 0 920 320" className="w-full h-auto max-w-[780px]" role="img" aria-label="Single Cut colorivel">
      ...
      case 'explorer':
        return (
          <svg viewBox="0 0 920 320" className="w-full h-auto max-w-[780px]" role="img" aria-label="Explorer colorivel">
      ...
      case 'flyingV':
        return (
          <svg viewBox="0 0 920 320" className="w-full h-auto max-w-[780px]" role="img" aria-label="Flying V colorivel">
      ...
      case 'contrabaixo':
        return (
          <svg viewBox="0 0 920 320" className="w-full h-auto max-w-[780px]" role="img" aria-label="Contrabaixo colorivel">
      ...
      case 'violao':
        return (
          <svg viewBox="0 0 920 320" className="w-full h-auto max-w-[780px]" role="img" aria-label="Violao colorivel">
      ...
      case 'banjo':
        return (
          <svg viewBox="0 0 920 320" className="w-full h-auto max-w-[780px]" role="img" aria-label="Banjo colorivel">
    ...
    <div className={`min-h-screen relative overflow-hidden p-4 md:p-8 ${isLight ? 'bg-slate-50 text-slate-900' : 'bg-zinc-950 text-zinc-100'}`}>
      ...
      <main className="relative mx-auto max-w-6xl">
        <header className="mb-6 md:mb-8 text-center">
          ...
          <h1 className="mt-2 text-3xl md:text-5xl font-black uppercase tracking-tight">Primeiros Passos</h1>
          <p className={`mt-3 text-sm md:text-base font-bold ${isLight ? 'text-slate-600' : 'text-zinc-300'}`}>
            Pinte as figuras dos instrumentos.
          </p>
        </header>
        ...
        <section className="grid gap-6 lg:grid-cols-[360px_1fr]">
          <aside className={`rounded-3xl border p-4 md:p-5 ${isLight ? 'border-slate-200 bg-white/90' : 'border-zinc-800 bg-zinc-900/80'}`}>
            ...
            <p className="mt-5 text-[10px] font-black uppercase tracking-[0.2em] mb-2">Partes</p>
