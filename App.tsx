...
import GearCurationManualPage from './components/GearCurationManualPage';
import GearPartnersPage from './components/GearPartnersPage';
...
import MyAcademyPage from './components/MyAcademyPage';
...
const App: React.FC = () => {
  ...
  const renderPage = () => {
    ...
    switch (path) {
      ...
      case '/gear/curadoria': return <GearCurationManualPage />;
      case '/gear/parceiros': return <GearPartnersPage />;
      ...
      case '/my-academy': return <MyAcademyPage />;
